...
public class InputCameraSudokuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera_bt = findViewById(R.id.camera_button);
        ...
        try{
            ...
            ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader imageReader) {
                    ...
                    int[][] sudoku = findSudoku(matImage);
                    sudoku[1][0] = 3;
                    Intent intent = new Intent(InputCameraSudokuActivity.this, OutputSudokuActivity.class);
                    intent.putExtra("image", sudoku);
    ...
    private int[][] findSudoku(Mat org_image){
