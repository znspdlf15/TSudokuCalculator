...
public class Preview extends Thread {
    ...
    public void openCamera() {
        ...
        try {
            ...
            if(permissionCamera == PackageManager.PERMISSION_DENIED) {
                ActivityCompat.requestPermissions((Activity) mContext, new String[]{Manifest.permission.CAMERA}, 299);
            } else {
    ...
    public void takePicture() {
        try {
            ...
            ImageReader mImageReader = ImageReader.newInstance(100, 100, ImageFormat.JPEG, 1);
            captureStillBuilder.addTarget(mImageReader.getSurface());

            captureStillBuilder.set(CaptureRequest.JPEG_ORIENTATION, 1);
            ...
            mPreviewSession.capture(captureStillBuilder.build(), captureCallback, null);
